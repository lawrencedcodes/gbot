# 👻 G-BOT: Autonomous Visual Desktop Agent
...
1.  **The Remote (React PWA):** A secure, mobile-first command deck where the human operator issues natural language directives ("Clean up this folder", "Sort these PDFs").
